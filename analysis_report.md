...
<img src="images/analysis/bubble_evaluation.png" alt="期別総合評価（バブルチャート）" style="max-width: 100%; width: 800px;">
...
|---------|-------|-------|----------|-------|----------|----------|
| 1〜10期 | 209名 | 39名 | **3.97** | **6,214円** | **25.6%** | **+714円** |
| 11〜20期 | 187名 | 43名 | 3.72 | 6,108円 | 14.0% | +608円 |
| 21〜30期 | 104名 | 19名 | 3.79 | 5,706円 | 10.5% | +206円 |
| 31〜37期 | 33名 | 9名 | 2.78 | 5,000円 | 11.1% | +2,000円 |

**キーインサイト**:
1. **ベテラン（1〜10期）は増額に寛容**
   - 25.6%が「金額より内容重視」と回答
   - 会費満足度3.97と高く、現行に不満なし
   - **7,000円程度まで増額可能**
...
**コメント回答数**: プログラム関連64件、飲食・会場関連72件（重複あり）

#### 3.2.1 課題別言及数と満足度への影響

| 課題 | 言及数 | 言及率 | 料理満足度への影響 | 会費満足度への影響 |
|-----|-------|-------|----------------|----------------|
| **音響問題** | 16件 | 14.4% | **-0.50点** | -0.21点 |
| **視認性** | 15件 | 13.5% | -0.04点 | +0.09点 |
| **会話との両立** | 11件 | 9.9% | **-0.49点** | - |
| **世代間交流** | 11件 | 9.9% | -0.31点 | +0.03点 |
| **料理量不足** | 9件 | 8.1% | **-0.53点** | -0.12点 |
| **飲み物種類** | 7件 | 6.3% | **-0.88点** | **-0.32点** |
| **会場狭さ** | 6件 | 5.4% | **-0.64点** | **-0.35点** |
| **料理配置** | 5件 | 4.5% | -0.31点 | - |

**重要な発見**:
- **飲み物種類への不満**が最も満足度を下げている（-0.88点）
- **会場狭さ**も料理・会費両方の満足度を下げる
- **音響問題**は言及数最多で料理満足度に影響（-0.50点）

#### 3.2.2 ポジティブ要因の分析

| ポジティブ要因 | 言及数 | 言及率 | 料理満足度への影響 |
|--------------|-------|-------|----------------|
| トークセッション評価 | 35件 | 31.5% | +0.15点 |
| 演奏・音楽評価 | 24件 | 21.6% | +0.02点 |
| 運営への感謝 | 12件 | 10.8% | +0.27点 |
| 楽しかった | 11件 | 9.9% | +0.14点 |
| 久しぶりの再会 | 7件 | 6.3% | -0.02点 |
| 料理美味しい | 2件 | 1.8% | **+0.69点** |
| 受付スムーズ | 2件 | 1.8% | **+1.19点** |
...
|----------|-------|
| 校歌斉唱（芸術科合唱つき） | 52.3% |
| 当時のスライドショー・思い出ビデオ | 51.4% |
| 学科・専門分野ごとの交流コーナー | 46.8% |
| 卒業生有志による音楽・パフォーマンス | 41.4% |
| 在校生の活動紹介 | 38.7% |
| スマッチョの披露・復活 | 33.3% |
| スマホ参加型企画（クイズ等） | 29.7% |
| 恩師によるミニ講話・ミニ授業 | 24.3% |
...
|-------------|------------|-------|----------------|
| 1〜10期（ベテラン） | 20名 | 40.8% | 51.3% |
| 11〜20期（中堅） | 19名 | 38.8% | 44.2% |
| 21〜30期（若手） | 7名 | 14.3% | 36.8% |
| 31期以降（新世代） | 3名 | 6.1% | 33.3% |
...
|---------|-------|------|
| **寄付や協賛による支援** | 46名 | **41.4%** |
| 具体的な相談があれば検討したい | 34名 | 30.6% |
| **母校の「特別授業」等の講師** | 30名 | **27.0%** |
| 広報協力（SNS、Web等） | 18名 | 16.2% |
| 次回の同窓会実行委員（企画・運営） | 11名 | 9.9% |
| 同窓会（雄飛会）の役員活動 | 6名 | 5.4% |
...
意欲高い50名のうち、約**26名（52%）が任意のメッセージを記入**
...
| 優先度 | 対象 | アプローチ方法 |
|-------|------|--------------|
| 高 | 講師希望者（30名） | 特別授業・事前イベントメンターへの声がけ |
| 高 | 実行委員希望者（11名） | 次回運営メンバーへの早期招集 |
| 中 | 広報協力希望者（18名） | SNS発信チームへの組織化 |
| 中 | 専門分野明記者（26名） | 分野別交流会の企画・運営依頼 |
...
3. **協賛獲得への活用**
   - 寄付希望46名への個人協賛オプション案内
   - 法人協賛の紹介依頼

4. **広報ネットワークの構築**
   - 広報協力希望18名をSNS発信チームに組織化
   - 期別・学科別の情報拡散を依頼
...
*分析実施日: 2026年1月14日（更新）*
*データソース: Peatix参加者名簿（533名）、Googleフォームアンケート回答（111名）*
